...
if __name__ is not None and "." in __name__:
    from .HookInterpreterParserParser import HookInterpreterParserParser
else:
    from HookInterpreterParserParser import HookInterpreterParserParser

# This class defines a complete listener for a parse tree produced by HookInterpreterParserParser.
class HookInterpreterParserListener(ParseTreeListener):
...
del HookInterpreterParserParser